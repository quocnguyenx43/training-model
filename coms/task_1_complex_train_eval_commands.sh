...
echo "lstm + vinai/phobert-base"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "vinai/phobert-base" --source_len 200 --batch_size 32 --learning_rate 0.001 --epochs 20

echo "lstm + uitnlp/visobert"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "uitnlp/visobert" --source_len 400 --batch_size 32 --learning_rate 0.001 --epochs 20

echo "lstm + uitnlp/CafeBERT"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "uitnlp/CafeBERT" --source_len 300 --batch_size 32 --learning_rate 0.001 --epochs 20

echo "lstm + xlm-roberta-base"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "xlm-roberta-base" --source_len 500 --batch_size 32 --learning_rate 0.001 --epochs 20

echo "lstm + bert-base-multilingual-cased"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "bert-base-multilingual-cased" --source_len 500 --batch_size 32 --learning_rate 0.001 --epochs 20

echo "lstm + distilbert-base-multilingual-cased"
python run_train_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "distilbert-base-multilingual-cased" --source_len 500 --batch_size 32 --learning_rate 0.001 --epochs 20
...
echo "lstm + vinai/phobert-base"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "vinai/phobert-base" --source_len 200 --batch_size 32

echo "lstm + uitnlp/visobert"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "uitnlp/visobert" --source_len 400 --batch_size 32

echo "lstm + uitnlp/CafeBERT"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "uitnlp/CafeBERT" --source_len 300 --batch_size 32

echo "lstm + xlm-roberta-base"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "xlm-roberta-base" --source_len 500 --batch_size 32

echo "lstm + bert-base-multilingual-cased"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "bert-base-multilingual-cased" --source_len 500 --batch_size 32

echo "lstm + distilbert-base-multilingual-cased"
python run_evaluation_cls_task.py --task "task-2" --model_type "lstm" --hidden_size 128 --num_layers 4 --model_name "distilbert-base-multilingual-cased" --source_len 500 --batch_size 32
