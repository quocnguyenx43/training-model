...
python run_train_cls_task.py --task "task-2" --model_type "simple" --model_name "vinai/phobert-base" --source_len 256 --batch_size 32 --epochs 20
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "vinai/phobert-base" --source_len 256 --batch_size 32
...
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "uitnlp/visobert" --source_len 512 --batch_size 32
...
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "uitnlp/CafeBERT" --source_len 512 --batch_size 32
...
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "xlm-roberta-base" --source_len 512 --batch_size 32
...
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "bert-base-multilingual-cased" --source_len 512 --batch_size 32
...
python run_evaluation_cls_task.py --task "task-2" --model_type "simple" --model_name "distilbert-base-multilingual-cased" --source_len 512 --batch_size 32
