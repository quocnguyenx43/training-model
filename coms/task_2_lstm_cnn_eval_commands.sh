...
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "vinai/phobert-base" --source_len 256 --batch_size 32

echo "cnn + uitnlp/visobert"
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "uitnlp/visobert" --source_len 512 --batch_size 32

echo "cnn + uitnlp/CafeBERT"
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "uitnlp/CafeBERT" --source_len 512 --batch_size 32

echo "cnn + xlm-roberta-base"
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "xlm-roberta-base" --source_len 512 --batch_size 32

echo "cnn + bert-base-multilingual-cased"
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "bert-base-multilingual-cased" --source_len 512 --batch_size 32

echo "cnn + distilbert-base-multilingual-cased"
python run_evaluation_cls_task.py --task "task-2" --model_type "cnn" --num_channels 256 --kernel_size 128 --padding 64 --model_name "distilbert-base-multilingual-cased" --source_len 512 --batch_size 32